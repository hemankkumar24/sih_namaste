    ...
    <div className='w-full h-screen bg-neutral-200 '>
            <div className='flex justify-center items-center h-full w-full'>
                <div className='w-128 h-128 bg-neutral-50 rounded-xl shadow-2xl p-10'>
                    ...
                    <div className='pt-5 flex justify-between items-center gap-1'>
                    ...
                    <div className='w-full text-center pt-2'>
                       Don't Have an Account? <span className='text-blue-600 
                        hover:text-blue-700 cursor-pointer pt-1' onClick={rerouteToSignUp}>Sign Up</span>
                        <br />
                        <div className='text-blue-700 hover:text-blue-800 cursor-pointer' onClick={rerouteToPatient}>Patient Login</div>
                    </div>
                </div>
            </div>
        </div>
